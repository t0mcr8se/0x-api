...
export function getErc20BridgeSourceToBridgeSource(source: ERC20BridgeSource): string {
    switch (source) {
        ...
        case ERC20BridgeSource.VoltStableSwap:
            return encodeBridgeSourceId(BridgeProtocol.Nerve, 'VoltStableSwap');
        // TODO: add more fuse sources
        ...
        case ERC20BridgeSource.VoltDex:
            return encodeBridgeSourceId(BridgeProtocol.UniswapV2, 'VoltDex');
...
export function createBridgeDataForBridgeOrder(order: OptimizedMarketBridgeOrder): string {
    ...
    switch (order.source) {
        ...
        case ERC20BridgeSource.FStable: {
            const fStableFillData = (order as OptimizedMarketBridgeOrder<GenericRouterFillData>).fillData;
...
const BRIDGE_ENCODERS: {
    ...
    [ERC20BridgeSource.VoltStableSwap]: curveEncoder,
    ...
    [ERC20BridgeSource.VoltDex]: routerAddressPathEncoder,
